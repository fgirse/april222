...
import TabelleBL from"../../components/bundesliga-table";
        ...
        <div className="example-wrapper">
          ...
          >
            <button
              type="button"
              onClick={openModal}
              className="mx-auto mb-[3vw] w-[170px] h-[200px] rounded-[24px] bg-[#edc513] text-[1.66rem] font-medium text-white hover:bg-opacity-70 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75"
            >
